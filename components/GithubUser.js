...
const GithubUser = (props) => {
  ...
  return (
    <div className="mx-auto mt-6 flex max-w-md min-h-[470px] flex-col items-center space-y-4 rounded-lg bg-gray-200 py-6 transition duration-300 ease-in dark:bg-[#121212] md:min-h-fit md:max-w-2xl">
       <UserProfile
      ...
      <div className=" flex w-full xl:max-w-xl lg:max-w-lg flex-col space-y-6 px-6 py-3">
