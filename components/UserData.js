...
const UserData = ({location, twitterUsername,blog, company}) => {
  return (
    <div className="grid grid-cols-1 gap-6 px-2 py-4 md:grid-cols-2 md:gap-x-10">
          <div className="flex mx-auto space-x-2 font-semibold text-white transition-colors duration-150 hover:text-blue-400">
          ...
          <div className="flex mx-auto items-center space-x-2 font-semibold text-white transition-colors duration-150 hover:text-blue-400">
            <svg
              width="20"
              height="20"
              fill="currentColor"
            ...
            <p className="font-mono text-sm font-medium text-gray-900 dark:text-gray-300">
              <a
                ...
                target="_blank"
              >
                {twitterUsername ? twitterUsername : "Non disponible"}
              </a>
            </p>
          </div>
          ...
          <div className="flex mx-auto space-x-2 font-semibold text-white transition-colors duration-150 hover:text-blue-400">
            ...
            <p className="font-sm font-mono text-sm font-medium text-gray-900 dark:text-gray-300">
              {company ? company : "Non disponible"}
            </p>
          </div>
        </div>
  )
